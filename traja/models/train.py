...
class HybridTrainer(object):
    ...
    def __init__(
        ...
        optimizer = Optimizer(
            self.model_type, self.model, self.optimizer_type, classify=classify
        )
    ...
    model_save_path: Directory path to save the model
            ...
            if epoch > 0:  # Initial step is to test and set LR schduler
                ...
                for idx, (data, target, category) in enumerate(train_loader):
                    ...
                    if training_mode == "forecasting":
                        ...
                        self.classifier_hidden_size
                        and training_mode is not "forecasting"
        ...
        # Save the model with its hyperparameters at target path
